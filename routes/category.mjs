...
import { authenticateToken, authenticateTokenAdmin } from "../security/tokenManagement.mjs";
...
router.get("/", async (req, res) => {
  ...
  // Category list must be visible for all roles
...
router.get("/:id", async (req, res) => {
  ...
  authenticateTokenAdmin(req, res, async () => {
    let collection = await db.collection("categories");
